...
<li><a href="updstud.php?name=<?php echo isset($_GET['name']) ? $_GET['name'] : ''; ?>&username=<?php echo isset($_GET['username']) ? $_GET['username'] : ''; ?>&email=<?php echo isset($_GET['email']) ? $_GET['email'] : ''; ?>&graduationdate=<?php echo isset($_GET['graduationdate']) ? $_GET['graduationdate'] : ''; ?>&major=<?php echo isset($_GET['major']) ? $_GET['major'] : ''; ?>&areaofinterest=<?php echo isset($_GET['areaofinterest']) ? $_GET['areaofinterest'] : ''; ?>&projects=<?php echo isset($_GET['projects']) ? $_GET['projects'] : ''; ?>&certifications=<?php echo isset($_GET['certifications']) ? $_GET['certifications'] : ''; ?>&technicalskills=<?php echo isset($_GET['technicalskills']) ? $_GET['technicalskills'] : ''; ?>&researchexperience=<?php echo isset($_GET['researchexperience']) ? $_GET['researchexperience'] : ''; ?>&workexperience=<?php echo isset($_GET['workexperience']) ? $_GET['workexperience'] : ''; ?>&academicachievements=<?php echo isset($_GET['academicachievements']) ? $_GET['academicachievements'] : ''; ?>"><i class="fa fa-edit"></i> Edit profile</a></li>
</ul>
</div>
</div>
...
<div class="bio-row">
<p><span>Graduation Date</span>: <?php echo isset($_GET['graduationdate']) ? $_GET['graduationdate'] : ''; ?></p>
</div> 
 <div class="bio-row">
...
<div class="bio-row">
    <p><span>Area of Interest</span>: <?php echo isset($_GET['areaofinterest']) ? str_replace(',', '<br>', $_GET['areaofinterest']) : ''; ?></p>
</div>

<div class="bio-row">
<p><span>Projects </span>: <?php echo isset($_GET['projects']) ? str_replace(',', '<br>',$_GET['projects']) : ''; ?></p>
</div>
<div class="bio-row">
<p><span>Certifications </span>: <?php echo isset($_GET['certifications']) ? str_replace(',', '<br>',$_GET['certifications']) : ''; ?></p>
</div>
...
<div class="bio-desk">
<h4 class="red">Technical Skills</h4>
<p><?php echo isset($_GET['technicalskills']) ? str_replace(',', '<br>',$_GET['technicalskills']) : ''; ?></p>
...
<div class="bio-desk">
<h4 class="terques">Academic Achievements</h4>
<p><?php echo isset($_GET['academicachievements']) ? str_replace(',', '<br>',$_GET['academicachievements']) : ''; ?></p>
...
<p><?php echo isset($_GET['workexperience']) ? str_replace(',', '<br>',$_GET['workexperience']) : ''; ?></p>
...
<p><?php echo isset($_GET['researchexperience']) ? str_replace(',', '<br>', $_GET['researchexperience']) : ''; ?></p>
</div>
</div>
</div>
</div>
...
<div class="center">
  ...
  <a href="srch.php"><button>Search</button></a>
  <a href="Issue form.html"><button>Help</button></a>
  <a href="A/index.php"><button>Build CV</button></a>
</div>
...
<script type="text/javascript">
        ...
        if (performance.navigation.type === 2) {
            // Page is loaded from the cache, display a message
            alert("Please click 'Save Profile' to save your changes.");
        }
