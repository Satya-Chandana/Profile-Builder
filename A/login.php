...
*{
	...
	.loginDiv{width: 366px;height: 600px;float: right;margin-right: 111px;background-color: rgba(0, 0, 0, 0.4);  opacity: inherit;;text-align: center;border: 1px solid blue;padding: 11px;box-shadow: 2px 1px 22px #1583DC}	
...
<body style="background: url('photo/logscreen.jpg');background-size: 100%">
	<div class='fontTreb' style="color: white;font-family: 'Raleway', sans-serif;font-size: 28pt;margin: 22px;text-shadow: 2px 2px 11px black">Online Profile Builder</div>
