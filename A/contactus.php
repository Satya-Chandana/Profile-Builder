...
<div class="hub-top">
	<div class="logo flex pull-left">
		...
		<div class="logoname treb"><span>Online  Profile Builder </span></div>
	</div>
...
<div class="well well-sm" style="margin-left: 18%;font-family: 'Acme', sans-serif;background:transparent;border:none;padding-top: 122px;background-color: rgba(0, 0, 0, 0.4);  opacity: inherit;">
  <div class="panel panel-primary"style="background-color:transparent;">
  		...
  		<div class="panel-body" style="font-size:20px;letter-spacing:1px;color: #ADD8E6;background:transparent;">
  			At our website, we are passionate about helping individuals and businesses create exceptional profiles that make a lasting impression. With our innovative platform, you can unleash your creativity and build a unique profile that truly represents your skills, expertise, and personality. Our intuitive interface allows you to customize every aspect of your profile, from selecting vibrant color schemes to incorporating multimedia elements, such as images, videos, and interactive charts. Join our community of satisfied users who have successfully built professional profiles using our Profile Builder System and elevate your online presence to new heights.
Thankyou for choosing our website as your go-to platform for profile creation. We are committed to providing you with continuous updates and support to ensure your profile always reflects your growth and achievements.
  		</div>
  ...
  <div class="panel panel-primary"style="background-color:transparent;">
  		...
  		<div class="panel-body" style="color: #ADD8E6;background:transparent;letter-spacing:1px">
  			<h3>
  				<i class="fa fa-phone fa-fw" ></i>9346254705
  				<br><br>
  				<i class="fa fa-book fa-fw"></i> vishnudheeraj2003@gmail.com
				<br><br>
  				<i class="fa fa-book fa-fw"></i> hemanthbehara676@gmail.com
				<br><br>
  				<i class="fa fa-book fa-fw"></i> sainikhil.nalluru@gmail.com
				  <br><br>
  				<i class="fa fa-book fa-fw"></i> sakethchowdary0@gmail.com.com
