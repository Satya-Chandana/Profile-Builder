...
.cover{padding: 11px;}
.cvBody{border:1px solid black; width: 59%;min-height: 744px;}
...
/* .body-item{} */
.body-head{font-size: 17pt;text-align: center;color: white;font-family: 'Acme', sans-serif;font-variant:small-caps;}
		...
		<div class="cvBody flex pull-left" >
			<div class="cv-head">
				<div class="photo center ">
					...
					<span style="color: black;" id="cvname">Morten Zain</span>
				</div>
				
				<div class="about-tab ">
					<div class="about-head">About Me</div>
					<div class="about-details" id="cvaboutme" style="background:#CBCBCB;color:black;padding:11px 3px">Write About yourself it may be objective or it may be about your future point of view.</div>
				</div>
				<div class="about-tab ">
					<div class="about-head" style="background:#FDBC00">Contact Me</div>
					<div class="about-details">
						<ul>
							<li id="cvphone1">998759980</li>
							<li id="cvphone2" style="display: none">080-996789</li>
			...
			<div class="cv-content">
				...
				<div class="body-item" id="personalMenu"><hr>
					<div class="body-head">Personal Information</div>
					<div class="body-details fontTreb" style="color: lightgreen">
						
						<div class="info-item"  id="pInfo1">
							<div class="info-item-head"><i class="fa fa-circle fa-fw"></i> <span id="cvKey1"> Key</span></div>
				...
				<table class="table table-striped table-hover">
			    	...
			    	<thread>
			    		<tr>
			    			...
			    			<td style="width: 55px;padding-left:0;padding-right:0"><button class="btn btn-primary btn-sm" id="pInfoBtn1">Hide/Show</button></td>
			    		</tr>
			    	</thread>
	...
	$("#uploadCv").click(function()
	{
		...
		alert(customestyle);
			...
			$.post({
				...
				url:'saveCv1.php',
				data:{data : cvData , name : cvName,style:customestyle,theme:"theme2"}
			}).done(function(result)
			{
